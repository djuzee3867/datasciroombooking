...
/**
 * แก้ไขรายละเอียดห้อง — ใช้ร่วมกันทั้งหน้าผู้ดูแลห้องและหน้าแอดมิน
 *
 * §4.2 กำหนดขอบเขตต่างกัน:
 *   ผู้ดูแลห้อง — คำอธิบาย · ข้อความถึงผู้จอง · อุปกรณ์ประจำห้อง
 *   แอดมิน      — ทั้งหมดข้างต้น + ชื่อ ประเภท ความจุ เวลาให้บริการ และการเปิด/ปิดห้อง
 *
 * ฟอร์มนี้ซ่อนช่องที่ผู้ใช้ไม่มีสิทธิ์แก้ และเซิร์ฟเวอร์ตรวจซ้ำอีกชั้นเสมอ
 */
  ...
  return (
    ...
    >
      <div className="space-y-4">
        {!canEditAll && (
          <Notice tone="info">
            ผู้ดูแลห้องแก้ได้เฉพาะคำอธิบาย ข้อความถึงผู้จอง และอุปกรณ์ประจำห้อง ·
            การเปลี่ยนความจุ เวลาให้บริการ หรือเปิด/ปิดห้อง ต้องให้แอดมินดำเนินการ
          </Notice>
        )}
